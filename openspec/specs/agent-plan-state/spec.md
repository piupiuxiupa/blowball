# agent-plan-state Specification

## Purpose

Define Confucius's turn-scoped semantic plan snapshots, host-authoritative revisions, sub-agent isolation, structured events, and persistence behavior.
